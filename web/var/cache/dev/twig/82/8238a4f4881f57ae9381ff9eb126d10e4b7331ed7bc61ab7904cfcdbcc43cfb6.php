...
class __TwigTemplate_874d7a226af34b3f92b101d566733377a7838eb83755babd6349735992a27250 extends Template
{
    private $source;
    private $macros = [];
...
(isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 168, $this->source); })()), "content", [], "any", false, false, false, 168)) {
        ...
        echo "</span>
                    ...
                    <div class=\"metric\">
                        <span class=\"value\">";
        // line 268
        echo twig_include($this->env, $context, (("@WebProfiler/Icon/" . ((twig_get_attribute($this->env, $this->source, (isset($context["collector"]) || array_key_exists("collector", $context) ? $context["collector"] : (function () { throw new RuntimeError('Variable "collector" does not exist.', 268, $this->source); })()), "statelesscheck", [], "any", false, false, false, 268)) ? ("yes") : ("no"))) . ".svg"));
        echo "</span>
